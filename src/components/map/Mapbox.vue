  ...
  async created() {
    ...
    this.$getLocation({})
      .then((coordinates) => {
        ...
        this.myCoordinates = coordinates; // as coorenaas tem que ser um array. A props do mapa aceitam somente array
        localStorage.setItem('coordinates', JSON.stringify(this.myCoordinates));
      })
